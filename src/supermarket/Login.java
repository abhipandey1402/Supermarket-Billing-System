...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/supermarket/cart-new.png"))); // NOI18N

        jLabel8.setBackground(new java.awt.Color(0, 0, 0));
        jLabel8.setFont(new java.awt.Font("Century Gothic", 1, 36)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Great service");
        ...
        jLabel11.setText("Good products ");
        ...
        RoleCb.setForeground(new java.awt.Color(102, 204, 0));
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 0, 36, 37));
...
ResultSet Rs = null;
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
       ...
       {
        String Query = "Select * from ABHI.SELLERTBL where SELLERNAME='"+Uid.getText()+"'and SELLERPASS='"+password.getText()+"'";
       try{
       ...
       {
             String Query = "Select * from ABHI.ADMINTBL where ADMINNAME='"+Uid.getText()+"'and ADMINPASS='"+password.getText()+"'";
       try{
        Con = DriverManager.getConnection("jdbc:derby://localhost:1527/SuperMarketdb","Abhi","1402");
        St = Con.createStatement();
        Rs = St.executeQuery(Query);
