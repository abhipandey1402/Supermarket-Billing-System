...
public class Selling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        FilterBtn.setBackground(new java.awt.Color(102, 204, 0));
        ...
        jPanel2.add(UpdateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 590, 121, -1));
        ...
        Grdtotallbl.setForeground(new java.awt.Color(102, 204, 0));
        Grdtotallbl.setText("Rs");
        jPanel2.add(Grdtotallbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 600, -1, 24));

        RefreshBtn.setBackground(new java.awt.Color(102, 204, 0));
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 420, -1, -1));
...
public void Update()
        ...
        try{
            Con = DriverManager.getConnection("jdbc:derby://localhost:1527/SuperMarketdb","Abhi","1402");
            String Query = "Update ABHI.PRODUCTTBL set PRODQTY="+newQty+""+"where PRODID="+Prid;
 ...
 private void GetCat()
 {
   ...
   }catch(Exception e)
   {
    ...
    Con = DriverManager.getConnection("jdbc:derby://localhost:1527/SuperMarketdb","Abhi","1402");
    St = Con.createStatement();
    Rs = St.executeQuery("Select *from ABHI.PRODUCTTBL where PRODCAT='"+CatCb.getSelectedItem().toString()+"'");
    ProductTable.setModel(DbUtils.resultSetToTableModel(Rs));
   }catch(Exception e)
   {
       e.printStackTrace();
